...
/**
 * Autor: Nestor Franco Objetivo: Objeto para vista - SubSeccion Limitaciones
 * Fecha: 22-05-2019 Nro. Req: 1 Version: 1.0
 */
public class LimitacionSubSeccionVO implements Serializable {
	...
	private BigDecimal LIMSEC;

	public BigDecimal getLIMAD2() {
