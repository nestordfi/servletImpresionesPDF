 ...
 * Objetivo:	Clase que encapsula los parametros de ConsultaDb2 hacia NCODIG
 * Fecha:		22-12-2017
 * Nro. Req:	1546
 * Version:		1.0
 */
public class ConsultaNcodigParametro {
	...
	public ConsultaNcodigParametro(String tabla, String nivel, String cod1, String cod2, String cod3, String cod4) {
		this.tabla = tabla;
		this.nivel = nivel;
		this.cod1 = cod1;
		this.cod2 = cod2;
